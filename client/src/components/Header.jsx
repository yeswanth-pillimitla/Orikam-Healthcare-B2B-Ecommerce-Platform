...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white px-4 md:px-6 py-3 shadow-2xs text-left">
      <div className="max-w-[1440px] mx-auto flex items-center justify-between gap-4">

        {/* Left: Orikam Logo */}
        <div className="flex items-center gap-4 shrink-0">
          <div onClick={() => navigateTo('home')} className="cursor-pointer">
            <img src="/Logo.png" alt="Orikam Logo" className="h-11 object-contain" />
          </div>
